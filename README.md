...
This is a Machine Learning project that classifies emails as *Spam* or *Ham* using Logistic Regression and TF-IDF Vectorization. The model is deployed using Flask.
